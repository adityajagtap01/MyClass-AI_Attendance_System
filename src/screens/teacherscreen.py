...
from src.Database.db import check_teacher_exists, create_teacher, teacher_login,create_student, get_all_students,get_teacher_subjects,get_attendance_for_teacher
...
def teacher_tab_attendance_records():
    ...
    for r in records:
        ...
        data.append({
            ...
            "Time": datetime.datetime.fromisoformat(ts).strftime("%Y-%m-%d %I:%M %p") if ts else "N'A",
